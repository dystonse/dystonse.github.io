---
layout: post
title:  "Demo Week - wir stellen unser Projekt vor"
authors: "Lena Schimmel, Kirstin Rohwer"
categories: demoweek, prototypefund
excerpt_separator: <!--more-->
---

Die 6 Monate Förderzeit der PrototypeFund-Runde 7 sind fast vorbei, und es ist in den letzten Wochen ziemlich ruhig geworden hier auf unserem Blog. Das liegt nicht etwas daran, dass wir aufgegeben hätten, sondern ganz im Gegenteil – wir waren so sehr ins Programmieren vertieft, dass kaum noch Zeit blieb, etwas Abstand zu nehmen und mal wieder darüber zu berichten.
...
Stattdessen wurde die Vorstellung der Projekte, wie so viele Events in dieser Zeit, zu einer Online-Veranstaltung umgestaltet. Heute Abend wird die [Demo Week](https://demoweek.prototypefund.de/) mit einem Livestream eröffnet, und dann werden im Lauf der Woche alle Projekte auf der Website und in Social Media vorgestellt.
